...
$root.Fixtures = (function() {
    ...
    Fixtures.Message = (function() {

        /**
         * Properties of a Message.
         * @memberof Fixtures
         * @interface IMessage
         * @property {Fixtures.IMessage|null} [lMessage] Message lMessage
         ...
         * @property {Fixtures.Enum|null} [singleEnum] Message singleEnum
         ...
         * @property {Fixtures.IMessage|null} [singleMessage] Message singleMessage
         ...
         * @property {Array.<Fixtures.IMessage>|null} [repeatedMessage] Message repeatedMessage
         ...
         * @implements IMessage
         * @constructor
         * @param {Fixtures.IMessage=} [properties] Properties to set
         */
        ...
        /**
         * Message lMessage.
         * @member {Fixtures.IMessage|null|undefined} lMessage
         * @memberof Fixtures.Message
         * @instance
         */
        ...
        /**
         * Message singleEnum.
         * @member {Fixtures.Enum} singleEnum
         * @memberof Fixtures.Message
         * @instance
         */
         ...
         * @member {Fixtures.IMessage|null|undefined} singleMessage
         * @memberof Fixtures.Message
         * @instance
         */
         ...
         * @member {Array.<Fixtures.IMessage>} repeatedMessage
         * @memberof Fixtures.Message
         * @instance
         */
         ...
         * @static
         * @param {Fixtures.IMessage=} [properties] Properties to set
         * @returns {Fixtures.Message} Message instance
         */
         ...
         * @memberof Fixtures.Message
         * @static
         * @param {Fixtures.IMessage} message Message message or plain object to encode
        ...
        Message.encode = function encode(message, writer) {
            ...
            if (message.lMessage != null && Object.hasOwnProperty.call(message, "lMessage"))
                $root.Fixtures.Message.encode(message.lMessage, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            ...
            if (message.singleMessage != null && Object.hasOwnProperty.call(message, "singleMessage"))
                $root.Fixtures.Message.encode(message.singleMessage, writer.uint32(/* id 27, wireType 2 =*/218).fork()).ldelim();
            ...
            if (message.repeatedMessage != null && message.repeatedMessage.length)
                for (var i = 0; i < message.repeatedMessage.length; ++i)
                    $root.Fixtures.Message.encode(message.repeatedMessage[i], writer.uint32(/* id 127, wireType 2 =*/1018).fork()).ldelim();
         ...
         * @returns {Fixtures.Message} Message
        ...
        Message.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Fixtures.Message();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
                        message.lMessage = $root.Fixtures.Message.decode(reader, reader.uint32());
                        break;
                    }
                case 11: {
                ...
                case 27: {
                        message.singleMessage = $root.Fixtures.Message.decode(reader, reader.uint32());
                        break;
                    }
                case 111: {
                ...
                case 127: {
                        if (!(message.repeatedMessage && message.repeatedMessage.length))
                            message.repeatedMessage = [];
                        message.repeatedMessage.push($root.Fixtures.Message.decode(reader, reader.uint32()));
                        break;
                    }
                case 211: {
        ...
        Message.verify = function verify(message) {
            ...
            if (message.lMessage != null && message.hasOwnProperty("lMessage")) {
                var error = $root.Fixtures.Message.verify(message.lMessage);
                if (error)
            ...
            if (message.singleMessage != null && message.hasOwnProperty("singleMessage")) {
                var error = $root.Fixtures.Message.verify(message.singleMessage);
                if (error)
            ...
            if (message.repeatedMessage != null && message.hasOwnProperty("repeatedMessage")) {
                ...
                for (var i = 0; i < message.repeatedMessage.length; ++i) {
                    var error = $root.Fixtures.Message.verify(message.repeatedMessage[i]);
                    if (error)
        ...
        Message.fromObject = function fromObject(object) {
            if (object instanceof $root.Fixtures.Message)
                return object;
            var message = new $root.Fixtures.Message();
            if (object.lMessage != null) {
                if (typeof object.lMessage !== "object")
                    throw TypeError(".Fixtures.Message.lMessage: object expected");
                message.lMessage = $root.Fixtures.Message.fromObject(object.lMessage);
            }
            ...
            if (object.singleMessage != null) {
                if (typeof object.singleMessage !== "object")
                    throw TypeError(".Fixtures.Message.singleMessage: object expected");
                message.singleMessage = $root.Fixtures.Message.fromObject(object.singleMessage);
            }
            if (object.repeatedInt32) {
                if (!Array.isArray(object.repeatedInt32))
                    throw TypeError(".Fixtures.Message.repeatedInt32: array expected");
                message.repeatedInt32 = [];
            ...
            if (object.repeatedString) {
                if (!Array.isArray(object.repeatedString))
                    throw TypeError(".Fixtures.Message.repeatedString: array expected");
                message.repeatedString = [];
            ...
            if (object.repeatedBytes) {
                if (!Array.isArray(object.repeatedBytes))
                    throw TypeError(".Fixtures.Message.repeatedBytes: array expected");
                message.repeatedBytes = [];
            ...
            if (object.repeatedMessage) {
                if (!Array.isArray(object.repeatedMessage))
                    throw TypeError(".Fixtures.Message.repeatedMessage: array expected");
                message.repeatedMessage = [];
                for (var i = 0; i < object.repeatedMessage.length; ++i) {
                    if (typeof object.repeatedMessage[i] !== "object")
                        throw TypeError(".Fixtures.Message.repeatedMessage: object expected");
                    message.repeatedMessage[i] = $root.Fixtures.Message.fromObject(object.repeatedMessage[i]);
                }
            }
            if (object.unpackedInt32) {
                if (!Array.isArray(object.unpackedInt32))
                    throw TypeError(".Fixtures.Message.unpackedInt32: array expected");
                message.unpackedInt32 = [];
         ...
         * @memberof Fixtures.Message
         * @static
         * @param {Fixtures.Message} message Message
        ...
        Message.toObject = function toObject(message, options) {
            ...
            if (message.lMessage != null && message.hasOwnProperty("lMessage"))
                object.lMessage = $root.Fixtures.Message.toObject(message.lMessage, options);
            if (message.singleInt32 != null && message.hasOwnProperty("singleInt32"))
            ...
            if (message.singleEnum != null && message.hasOwnProperty("singleEnum"))
                object.singleEnum = options.enums === String ? $root.Fixtures.Enum[message.singleEnum] === undefined ? message.singleEnum : $root.Fixtures.Enum[message.singleEnum] : message.singleEnum;
            if (message.singleFixed64 != null && message.hasOwnProperty("singleFixed64"))
            ...
            if (message.singleMessage != null && message.hasOwnProperty("singleMessage"))
                object.singleMessage = $root.Fixtures.Message.toObject(message.singleMessage, options);
            if (message.repeatedInt32 && message.repeatedInt32.length) {
                object.repeatedInt32 = [];
            ...
            if (message.repeatedMessage && message.repeatedMessage.length) {
                ...
                for (var j = 0; j < message.repeatedMessage.length; ++j)
                    object.repeatedMessage[j] = $root.Fixtures.Message.toObject(message.repeatedMessage[j], options);
            }
            if (message.unpackedInt32 && message.unpackedInt32.length) {
                object.unpackedInt32 = [];
        ...
        Message.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/Fixtures.Message";
        };
